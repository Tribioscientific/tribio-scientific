...
const PharmacopiealReferenceStandards = () =>{

    return(
        <>
        <div  class="relative bg-[url(/images/pharmacopieal.jpg)] bg-cover bg-center bg-no-repeat lg:h-[500px]">
    <div
    ...
    >
      ...
      {/* <img
        ...
        <h1 class="text-3xl font-extrabold sm:text-5xl">
          ...
          Pharmacopieal Reference Standards
          </strong>
        </h1>
        ...
        <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
          <div class="px-6 py-12 md:px-12">
           ...
           - Pharmacopieal Reference Standards
            ...
            These drug reference standardas are for the intended use described in pharmacopeial texts (monographs and general chapters). Pharmacopeial reference standards are available from various pharmacopoeias such as United States Pharmacopeia and the European Pharmacopoeia.
...
export default PharmacopiealReferenceStandards;