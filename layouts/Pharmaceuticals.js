...
<div className="mt-8 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16"> 
  <div class="lg:py-1">
    ...
    <div class="w-full"> 
            ...
            <h6>Products Link :-</h6>
                <Link class="flex items-center -mx-2 hover:text-primary hover:underline"  href="/pharmaceuticals-standards"> 
                    <span class="mx-2"> • Pharmaceuticals Standards </span>
                </Link>

                <Link class="flex items-center -mx-2 hover:text-primary hover:underline"  href="/pharmaceuticals-impurities"> 
                    <span class="mx-2"> •  Pharmaceuticals Impurities </span>
                </Link>
