...
const Nutrients = ({ data }) => {
 ...
 <div  class="relative bg-[url(/images/nutrients.png)] bg-cover bg-center bg-no-repeat lg:h-[500px]"
  >
    <div
      ...
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          <span className="relative inline-block">
            ...
            <span className="relative"> Fermentation </span>
          </span>{' '}
            ...
            <div class="grid mt-5 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 gap-x-6">
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>Helps to improve fermentation efficiency, alcohol yield and shorten fermentation time. 
                </p>
              </div>
              ...
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>NutriF-M also provide the necessary nutrients for maintaining yeast growth and vitality of yeast cells.
                </p>
              </div>
              ...
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>Replaces chemical based nutrients
                </p>
              </div>
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>	Enhances consistent fermentation and yields.
                </p>
              </div>
              ...
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>Can be used in high gravity fermentation process.
                </p>
              </div>
              ...
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>Accelerate the yeast metabolism and is critical in mitigating yeast stress.
                </p>
              </div>
      ...
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        ...
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-bold leading-none tracking-tight text-gray-900 sm:text-4xl md:mx-auto">
          <span className="relative inline-block">
            ...
            <span className="relative"> Waste Water Treatment  </span>
          </span>{' '}
      ...
      <div class="flex flex-wrap items-center">
        ...
        <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
          <div class="px-6 py-12 md:px-12">
            ...
            <i>A Symbiotic blend of Bio-Nutrients for replacing inorganic nitrogen & phosphorus sources like Urea & DAP and other essential micronutrients like Zn, Mg etc. for bacterial growth in both type of water treatment like anaerobic and aerobic process.</i>
            <p class="text-gray-500 mb-6">
            ...
            <div class="grid mt-5 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 gap-x-6">
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>Boosts in Micro-Organisms cell growth and multiplication.
                </p>
              </div>
              ...
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>Provides all vital nutrients – no need to add any nitrogen source.
                </p>
              </div>
              ...
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>	Hydrolyses protein and peptides into precious assailable nitrogen.
                </p>
              </div>
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>		Higher productivity and low by-product formation.
                </p>
              </div>
              ...
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>	100% Organic & water-soluble base.
                </p>
              </div> 
      ...
      <div class="flex flex-wrap items-center">
        ...
        <div class="grow-0 shrink-0 basis-auto w-full lg:w-6/12 xl:w-8/12">
          <div class="px-6 py-12 md:px-12">
            ...
            <i>A blend of Micro & Marco nutrient for conversion of VFA into methane gas generation of all type of anaerobic process like USAB, ICX, IC & Biodigester as well.</i>
            <p class="text-gray-500 mb-6">
            ...
            <div class="grid mt-5 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 gap-x-6">
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>Supports robustness & viability of Anaerobic microorganism
                </p>
              </div>
              ...
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>Helps to methane production CH4 and add all micronutrients to your reactors.
                </p>
              </div>
              ...
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>		Convert fatty acid and biomass in methane and Reduce and minimize VFA
                </p>
              </div>
              <div class="mb-6">
                <p class="flex items-center">
                  ...
                  </svg>			Help to reduce COD & BOD load.
                </p>
              </div>
